...
> R: Deja el carrito en un estado vacío y consistente antes de usarlo.
...
> R:Esta en la linea 24 y dice que suma únicamente el precio unitario de cada producto, ignorando el campo cantidad de ese producto
...
> R:Sí, hay líneas con #####: son las líneas 29 y 30 de carrito.c, dentro de la función carrito_descuento.
